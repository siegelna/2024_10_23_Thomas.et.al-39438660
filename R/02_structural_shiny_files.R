...
## Make files
makeShinyCodesMulti( shiny.title = "IBD Tissue Biopsies scRNAseq (13965420), Immune Cells", shiny.footnotes = NULL, shiny.prefix = c("sc1", "sc2", "sc3", "sc4"), shiny.headers = c("Endothelium", "Epithelium (Ileal)", "epithelium (Colonic)", "fibroblast and Pericyte"),  shiny.dir = "IBD_biopsy_scRNAseqzenodoID13965420_structural/") 