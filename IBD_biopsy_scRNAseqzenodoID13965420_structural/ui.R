...
### Page title 
titlePanel("IBD Tissue Biopsies scRNAseq (13965420), Structural Cells"),  
navbarPage( 
  NULL,  
 navbarMenu("Endothelium",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
...
navbarMenu("Epithelium (Ileal)",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
...
navbarMenu("fibroblast and Pericyte",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
